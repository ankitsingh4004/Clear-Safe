...
public class SendAnswerData extends AsyncTask<Object, Void, Object> {
    ...
    public SendAnswerData(Context context, JSONArray jsonArray, String url, OnTaskCompleted<String> listener, boolean isDialog)
    {
        this.url=url;
