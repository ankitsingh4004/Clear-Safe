...
public class AssesmentPOJO implements Serializable {
    ...
    @SerializedName("clientOrdereNo")
    @Expose
    private String clientOrdereNo;
    ...
    public String getClientOrdereNo() {
        return clientOrdereNo;
    }

    public void setClientOrdereNo(String clientOrdereNo) {
        this.clientOrdereNo = clientOrdereNo;
    }
