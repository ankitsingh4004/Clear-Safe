...
public class GetApiCall extends AsyncTask<Object, Void, Object> {
    ...
    public GetApiCall(Context context, String url, OnTaskCompleted<String> listener, boolean isDialog)
    {
        this.url=url;
