...
public class SendData1 extends AsyncTask<Object, Void, Object> {
    ...
    public SendData1(Context context, JSONObject jsonObject, String url, OnTaskCompleted<String> listener, boolean isDialog)
    {
        this.url=url;
    ...
    protected Object doInBackground(Object... objects) {
        try {
          ...
          //  httpPost.setHeader(new BasicHeader("Authorization", "Bearer " + Constants.loginPOJO.getAccess_token()));
