                ...
                public void onResponse(Call<List<WorkOrderResponseModel>> call, Response<List<WorkOrderResponseModel>> response) {
                    try {
                        ...
                        if (response.body() != null) {
                            ...
                            Constants.workOrderList=response.body();
...
/*
            ...
            final Call<List<WorkOrderResponseModel>> workOrderResponseModelCall= apiServicesWorkOrder.workOrderList("application/json","api/order/orderlist?rolename="+ Constants.loginPOJO.getUserRole()+"&companyid="+  Constants.loginPOJO.getPersonCompanyId());
            workOrderResponseModelCall.enqueue(new Callback<List<WorkOrderResponseModel>>() {
                @Override
                public void onResponse(Call<List<WorkOrderResponseModel>> call, Response<List<WorkOrderResponseModel>> response) {
                    try {
