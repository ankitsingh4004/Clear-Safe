...
public class ClientListResponse {
    ...
    public ParentPerson getParentPerson() {
        return parentPerson;
    }

    public void setParentPerson(ParentPerson parentPerson) {
    ...
    public class ParentPerson {
        ...
        public Object getParentPersonID() {
            return parentPersonID;
        }

        public void setParentPersonID(Object parentPersonID) {
            this.parentPersonID = parentPersonID;
        }
