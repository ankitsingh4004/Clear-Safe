...
public class DashboardClient implements Serializable {
    ...
    @Expose
    private ArrayList<ClientTreeStructure> treestuctutr = null;
    ...
    public ArrayList<ClientTreeStructure> getClientTreeStructure() {
        return treestuctutr;
    }

    public void setClientTreeStructure(ArrayList<ClientTreeStructure> treestuctutr) {
